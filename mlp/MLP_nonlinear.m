%Implementation of MLP non-linear
clc
clear all
...
while true
    ...
    for i=1:m
        ...
        %activation function at Input -> Hidden layer
        Z1_1_non(i,:) = nonlinear(Z1_1(i,:));
        
        %after nonlinear function applied
        Z2_1(i)=Z1_1_non(i,:)*W2_1+b_2;
        
        del_2_1(i)=(Z2_1(i)-data(i,n));
        del_1_1(i)=del_2_1(i)*W2_1(1,1);
        del_1_2(i)=del_2_1(i)*W2_1(2,1);
    ...
    for i=1:m
        ...
        del_W2_1=del_W2_1-mu*del_2_1(i)*Z1_1_non(i,:)';     %diff W2_1
    ...
    per(epo,2)=epo;
    if norm(Z2_1-data(:,n)')/norm(data(:,n))<10^-6 || epo>=10000
        Z2_1'
        epo
        break;
    end
